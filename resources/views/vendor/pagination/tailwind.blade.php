                    ...
                    {{-- Pagination Elements --}}
                        @if ($paginator->currentPage() <= 3)
                            ...
                            @for ($page = 1; $page <= min(3, $paginator->lastPage()); $page++)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-gray-200 border border-gray-300">
                                            {{ $page }}
                                        </span>
                                    </span>
                                @else
                                    <a href="{{ $paginator->url($page) }}"
                                    class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:bg-gray-100">
                                        {{ $page }}
                                    </a>
                                @endif
                            @endfor
                            ...
                            @if ($paginator->lastPage() > 3)
                                <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300">
                                    ...
                                </span>
